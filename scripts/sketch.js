...
let str = ["Design","UX Design", "Visual Design","Interaction Design", "Student","Web Development"]
...
function setup() {
  ...
  for (i=0; i<10; i++) {
    squareBackground[i] = new Square(random(windowWidth/2,windowWidth) , random(0,windowHeight), random(50,150), random(1,50) ,random(0.1,0.5));
  }
}
...
class Square {
  ...
  movement() {
    ...
    else if (this.reverseMove==false && this.x>windowWidth/2) {
      this.x-=this.s;
    }
    //hit side
